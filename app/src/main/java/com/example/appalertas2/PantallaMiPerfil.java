...
public class PantallaMiPerfil extends AppCompatActivity {
    Button btnDatosGrles, btnInfoAdicional, btnRMiPerfil, btnModificar, btnAgregar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInfoAdicional.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), PantallaInformacionAdicional.class);
                startActivity(i);
            }
        });
